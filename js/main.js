...
function handleAnimation(entries, observer) {
  ...
  const intersectionObserver = new IntersectionObserver(handleAnimation, options);
  const target = document.querySelector('#skills3');
  intersectionObserver.observe(target);
  
  // Re-observe the element when it becomes hidden
  ...
  intersectionObserver2.observe(target);
